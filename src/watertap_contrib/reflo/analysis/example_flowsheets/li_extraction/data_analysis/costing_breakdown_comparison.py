...
def calculate_lithium_costs_model1(inflation_factor=1.0):
    ...
    watertap_capex_solids_handling_raw = 440.8 * inflation_factor      # Million USD
    watertap_capex_liner_cost_raw = 273.4 * inflation_factor           # Million USD
    ...
    watertap_capex_dike_cost_raw = 103.5 * inflation_factor             # Million USD
    ...
    watertap_capex_land_clearing_cost_raw = 17.0 * inflation_factor    # Million USD
    watertap_capex_road_cost_raw = 8.9 * inflation_factor              # Million USD
    ...
    watertap_opex_electricity_raw = 69.3 * inflation_factor            # Million USD/year
    watertap_opex_solids_handling_raw = 153.9 * inflation_factor        # Million USD/year
    watertap_opex_government_agreements_raw = 131.8 * inflation_factor  # Million USD/year
    watertap_opex_shipping_raw = 23.7 * inflation_factor               # Million USD/year
    watertap_opex_maintenance_labor_chemical_raw = 35.7 * inflation_factor  # Million USD/year
    watertap_opex_liner_replacement_raw = 13.7 * inflation_factor       # Million USD/year
...
def calculate_lithium_costs_model2(inflation_factor=1.0):
    ...
    watertap_capex_solids_handling_raw = 440.8 * inflation_factor      # Million USD
    watertap_capex_liner_cost_raw = 253.2 * inflation_factor           # Million USD
    watertap_capex_well_cost_raw = 104.7 * inflation_factor            # Million USD
    watertap_capex_pipe_pump_cost_raw = 104.7 * inflation_factor       # Million USD
    watertap_capex_dike_cost_raw = 99.7 * inflation_factor             # Million USD
    watertap_capex_shipping_cost_raw = 49.4 * inflation_factor         # Million USD
    watertap_capex_electrical_cost_raw = 38.9 * inflation_factor       # Million USD
    watertap_capex_land_clearing_cost_raw = 15.9 * inflation_factor    # Million USD
    watertap_capex_road_cost_raw = 8.6 * inflation_factor              # Million USD
    ...
    watertap_opex_government_agreements_raw = 131.8 * inflation_factor  # Million USD/year
    watertap_opex_shipping_raw = 23.7 * inflation_factor               # Million USD/year
    watertap_opex_maintenance_labor_chemical_raw = 35.0 * inflation_factor  # Million USD/year
    watertap_opex_liner_replacement_raw = 12.7 * inflation_factor       # Million USD/year
...
inflation_factor = 1.0  # Change this value to adjust for inflation
...
opex_breakdown_model1 = {
    'Precipitated salts processing\n(opex)': costs_model1['watertap_opex_solids_handling_pct'],
...
opex_breakdown_model2 = {
    'Precipitated salts processing\n(opex)': costs_model2['watertap_opex_solids_handling_pct'],
...
ax2.set_xlim(0, 0.5)  # Set x-axis limits for Model 2 plot
...
for category, value in zip(opex_breakdown_model1.keys(), opex_values_model1):
    print(f"  {category}: ${value:.0f} ({list(opex_breakdown_model1.values())[list(opex_breakdown_model1.keys()).index(category)]*100:.1f}%)")
...
for category, value in zip(opex_breakdown_model2.keys(), opex_values_model2):
    print(f"  {category}: ${value:.0f} ({list(opex_breakdown_model2.values())[list(opex_breakdown_model2.keys()).index(category)]*100:.1f}%)")
